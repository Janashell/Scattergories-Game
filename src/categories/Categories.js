        ...
        <div className = 'Categories'>
            <div className = 'Categories-Main'>
                ...
                <ol className="Categories-Main-Display">
                  {/* Using the Map Method to create lis (AKA list items) using the categories for the current list. The current list is determined by the current value for the "list" state value*/}
